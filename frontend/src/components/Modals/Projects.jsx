...
export default function Projects({project, setProject}) {
  ...
  return (
    <Dialog open={project} onClose={setProject} className="relative z-10">
      <DialogBackdrop
        transition
          ...
          >
            <div className="bg-[#2C2C36] px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                <TriangleAlert className='text-white size-6 p-0' />
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div className="mt-2">
                    ...
                    Al momento non ho nulla da mostrare....torna più tardi
                    </p>
                  </div>
                </div>
              </div>
